...
def build_mf(alt, zh, dzdr):
    ...
    if alt == 0:
        ...
        mf_h1 = [
            [45, 52, 62, 67],
            [g2(const, -0.3), g2(const), g1(const), g1(const, 0.3)],
            [0.94, 0.96, 0.98, 1.00],
        ]
        mf_h2 = [
            [50, 60, 65, 70],
            [g3(const, -0.3), g3(const), g2(const), g2(const, 0.3)],
            [0.80, 0.91, 0.97, 0.98],
        ]
        mf_h3 = [
            [52, 62, 100, 101],
            [c(const, -8.75), c(const, -7.75), g3(const), g3(const, 0.3)],
            [-1.00, 0.00, 0.96, 0.98],
        ]
        ...
        mf_h1 = [
            [45, 49, 59, 64],
            [f2(const, -0.3), f2(const), f1(const), f1(const, 0.3)],
            [0.91, 0.94, 0.96, 0.99],
        ]
        mf_h2 = [
            [50, 57, 62, 67],
            [f3(const, -0.3), f3(const), f2(const), f2(const, 0.3)],
            [0.80, 0.90, 0.96, 0.99],
        ]
        mf_h3 = [
            [50, 59, 100, 101],
            [c(const, -8.75), c(const, -7.75), f3(const), f3(const, 0.3)],
            [-1.00, 0.00, 0.93, 0.98],
        ]
